...
{	
	...
	vec3 reflectMap = vec3(texture(material.texture_reflection1, texturePos));
	result += vec3(texture(material.texture_cube_map1, R).rgb) * reflectMap * 2;
